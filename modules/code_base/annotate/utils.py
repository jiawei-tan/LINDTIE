'''
Module      : utils
Description : Provides utility functions for the annotation pipeline
Copyright   : (c) Jia Wei Tan, Dec 2025
License     : MIT
Maintainer  : https://github.com/jiawei-tan
Portability : POSIX

Provides utility functions for the annotation pipeline. 
It includes functions for error handling, logging, and caching.
