'''
Module      : constants
Description : Provides constants required for the annotation pipeline
Copyright   : (c) Jia Wei Tan, Dec 2025
License     : MIT
Maintainer  : https://github.com/jiawei-tan
Portability : POSIX
Defines constants used throughout the annotation pipeline. 
It provides standardized exit codes, default cutoff thresholds, 
VCF field definitions, and CIGAR-string category mappings required 
for consistent variant annotation.
