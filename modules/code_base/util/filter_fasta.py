'''
Module      : filter_fasta
Description : Filters a FASTA file to only include sequences in a given list
Copyright   : (c) Jia Wei Tan, Dec 2025
License     : MIT
Maintainer  : https://github.com/jiawei-tan
Portability : POSIX
Reads the FASTA file and the list of sequences, and writes the filtered 
FASTA file to a new file.
